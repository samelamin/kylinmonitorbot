...
COIN_CHART_GECKO = "https://api.coingecko.com/api/v3/coins/kylin/market_chart?vs_currency=usd&days={days}"
COIN_RANK_GECKO = "https://api.coingecko.com/api/v3/coins/kylin?" \
