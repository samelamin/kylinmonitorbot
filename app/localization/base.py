...
class BaseLocalization(ABC):  # == English
    ...
    TEXT_AVA_WELCOME = '🖼️ Drop me a square picture and I make you kylin-styled avatar with a gradient frame.'
    ...
    TEXT_AVA_READY = '🥳 <b>Your kylin avatar is ready!</b> Download this image and set it as a profile picture' \
